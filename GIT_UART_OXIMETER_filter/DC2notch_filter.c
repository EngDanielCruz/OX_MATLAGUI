...
float DC2notch_filter_coefficients[5] =
{
// Scaled for floating point

        0.956543225556877, -1.913086451113754, 0.956543225556877, 1.9111970674260732, -0.9149758348014339// b0, b1, b2, a1, a2
...
{
    DC2notch_filterType *result = (DC2notch_filterType *)malloc( sizeof( DC2notch_filterType ) );   // Allocate memory for the object
    DC2notch_filter_init( result );                                         // Initialize it
...
{
    DC2notch_filter_executionState executionState;          // The executionState structure holds call data, minimizing stack reads and writes
    ...
    executionState.pCoefficients = DC2notch_filter_coefficients;    // Each call to filterBiquad() will advance pState and pCoefficients to the next biquad
    ...
    DC2notch_filter_filterBiquad( &executionState );        // Run biquad #0
