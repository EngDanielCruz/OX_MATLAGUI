...
float DCnotch_filter_coefficients[5] =
{
// Scaled for floating point

        1, -1, 0, 0.97, 0 // b0, b1, b2, a1, a2
...
{
    DCnotch_filterType *result = (DCnotch_filterType *)malloc( sizeof( DCnotch_filterType ) );  // Allocate memory for the object
    DCnotch_filter_init( result );                                          // Initialize it
...
{
    DCnotch_filter_executionState executionState;          // The executionState structure holds call data, minimizing stack reads and writes
    ...
    executionState.pCoefficients = DCnotch_filter_coefficients;    // Each call to filterBiquad() will advance pState and pCoefficients to the next biquad
    ...
    DCnotch_filter_filterBiquad( &executionState );     // Run biquad #0
